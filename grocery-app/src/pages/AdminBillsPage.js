...
import { TableWrapper, Badge, EmptyState, ModalOverlay, ModalContent } from '../styledComponents/FormStyles';
                            ...
                            <ModalOverlay onClick={() => this.setState({ showModal: false })}>
                                <ModalContent style={{ maxWidth: '720px' }} onClick={(e) => e.stopPropagation()}>
                                    <div className="modal-header">
                                        <h3>Order Details</h3>
                                        <button className="close-btn" onClick={() => this.setState({ showModal: false })}>
                                            ×
                                        </button>
                                    </div>
                                    ...
                                    <div className="modal-body">
                                        <div className="row g-3 mb-3">
                                            <div className="col-12 col-md-6">
                                                ...
                                                <div className="fw-semibold">{this.state.selectedOrder.id}</div>
                                            </div>
                                            <div className="col-12 col-md-6">
                                                <div className="text-muted small">Customer</div>
                                                <div className="fw-semibold">{this.state.selectedOrder.customerName || '-'}</div>
                                            </div>
                                            <div className="col-12 col-md-6">
                                                <div className="text-muted small">Phone</div>
                                                <div className="fw-semibold">{this.state.selectedOrder.phone || '-'}</div>
                                            </div>
                                            <div className="col-12 col-md-6">
                                                <div className="text-muted small">Order Type</div>
                                                <div className="fw-semibold">{this.state.selectedOrder.orderType || '-'}</div>
                                            </div>
                                            <div className="col-12 col-md-6">
                                                <div className="text-muted small">Status</div>
                                                <div className="fw-semibold">{this.state.selectedOrder.status || '-'}</div>
                                            </div>
                                            <div className="col-12 col-md-6">
                                                <div className="text-muted small">Date</div>
                                                <div className="fw-semibold">
                                                    {this.formatDate(this.getBillDate(this.state.selectedOrder) || this.state.selectedOrder.orderDate || this.state.selectedOrder.date)}
                                                </div>
                                            </div>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center" style={{ marginBottom: '0.25rem' }}>
                                            ...
                                            <span className="fw-bold" style={{ fontSize: '1.05rem' }}>
                                                ...
                                                {(() => {
                                                    ...
                                                    if (status === 'Completed') {
                                                        return <span className="text-success fw-semibold" style={{ marginLeft: '0.4rem', fontSize: '0.95rem' }}>(Paid)</span>;
                                                    }
                                                    if (status === 'Rejected') {
                                                        return <span className="text-danger fw-semibold" style={{ marginLeft: '0.4rem', fontSize: '0.95rem' }}>(Unpaid)</span>;
                                                    }
                                                    return null;
                                                })()}
                                            </span>
                                    ...
                                    <div className="modal-footer">
                                        <button type="button" className="btn btn-outline-secondary btn-sm" onClick={() => this.setState({ showModal: false })}>
                                            Close
                                        </button>
                                    </div>
                                </ModalContent>
